...
const Question = (props: {question: Question, choices?: Day[], setChoices: Dispatch<SetStateAction<Day[] | undefined>>, questionNb : number, setQuestionNb: Dispatch<SetStateAction<number>>}) => {
    // For form
